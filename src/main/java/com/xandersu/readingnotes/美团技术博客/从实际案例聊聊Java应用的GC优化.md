...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/ab15459b.png alt)
...
<table><thead><tr><th>空间</th><th>倍数</th></tr></thead><tbody><tr><td>总大小</td><td>**3-4** 倍活跃数据的大小</td></tr><tr><td>新生代</td><td>**1-1.5** 活跃数据的大小</td></tr><tr><td>老年代</td><td>**2-3** 倍活跃数据的大小</td></tr><tr><td>永久代</td><td>**1.2-1.5** 倍Full GC后的永久代空间占用</td></tr></tbody></table>
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/f6e7326e.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/6eb9b856.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/1470cba5.png alt)
...
调整前：![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/a1532bd7.png alt)

调整后：![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/ae11fb41.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/ee8d24f9.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/09cf176b.png alt)

可见，Remark阶段主要是通过扫描堆来判断对象是否存活。那么准确判断对象是否存活，需要扫描哪些对象？CMS对老年代做回收，Remark阶段仅扫描老年代是否可行？结论是不可行，原因如下：
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/eaa94379.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/6b73e4c0.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/df96e180.png alt)
...
![](https://awps-assets.meituan.net/mit-x/blog-images-bundle-2017/b15554ea.png alt)
...
1.  Scott O. Java Performance:The Definitive Guide. O&rsquo;Reilly, 2014.
